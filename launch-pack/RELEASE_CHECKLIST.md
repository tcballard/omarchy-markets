...
| --- | --- | --- | --- | --- | --- |
| Release identity | Version and candidate commit agree | Manifest 0.3.0; exact commit recorded at handoff | Pass | Tom Ballard | Preserve identity through public push. |
