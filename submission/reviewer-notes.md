...
- Runtime dependency: Python 3.10 or newer; standard library only
...
- Expected review capability: QML `Process` execution in `Service.qml` to invoke the bundled fixed helper by argument array
